        ...
        <div className="card-body">
          ...
          <div className="row mb-4">
            <div className="col-md-4">
              <h5>Supplier</h5>
              <select onChange={handleSelectSupplier} className="form-select mb-2" name='supplier'>
              ...
              <p>Email: {selectSupplier && selectSupplier.email}<span id="email"></span></p>
            </div>
            <div className="col-md-4">
              <h5>Warehouse</h5>
              <select onChange={handleSelectWarehouse} className="form-select" name='warehouse'>
          ...
          <table className="table table-bordered">
            <thead>
              ...
              <tr>
                <td>
                  <select onChange={handleProduct} className="form-select" name='product'>
